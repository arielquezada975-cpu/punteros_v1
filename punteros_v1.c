...
int main(int argc, char *argv[]) 
{
    ...
    ptrF = &decimal; // Asigna la dirección de decimal a ptrF
    dec = *ptrF; // Asigna el valor al que apunta ptrF a dec

    printf("%p %f \n",ptrF, dec); // Imprime la dirección de decimal y su valor
